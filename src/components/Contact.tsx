	...
	return (
		<section className="py-20 pb-12 bg-gray-50 dark:bg-gray-900 transition-colors duration-300" id="contacto">
			<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
		                      ...
		                      dark:hover:text-blue-400 transition-colors"
									...
									<div className="flex justify-center lg:justify-center items-center">
										<div className="group relative">
											<style>{`
												@keyframes rotate-infinite-contact {
													from {
				...
				.group:hover .svg-rotate-on-hover-contact {
					animation: rotate-infinite-contact 2s linear infinite;
				}
											`}</style>
											<div
											...
											>
											<svg 
												className="size-20 text-white svg-rotate-on-hover-contact transition-all duration-300 ease-in-out"
